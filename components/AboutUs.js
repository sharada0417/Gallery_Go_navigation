        ...
        <View style={styles.mainContainer}>
          <View style={styles.container}>
            ...
            <View style={styles.buttonsection}>
              <Button icon="camera" mode="outlined" onPress={() => navigation.push('aboutus')} style={styles.btn}>
                Call Again
              </Button>
              <Button mode="outlined" onPress={() => navigation.popTo('home')} style={styles.btn}>
                Go to Home
              </Button>
...
const styles = StyleSheet.create({
  ...
  btn: {
    marginVertical: 10, // This ensures vertical space between each button
  },
});
